...
import project3.ShopQuanAo.Entity.Product;
import project3.ShopQuanAo.Repository.CategoryRepo;
import project3.ShopQuanAo.Repository.ProductRepo;
...
//	}
	...
	@PostMapping("/add")
	public String add(@ModelAttribute @Valid Product product, @RequestParam("file") MultipartFile file)
			throws IllegalStateException, IOException {

		if (!file.isEmpty()) {
			final String UPLOAD_FOLDEL = "/C:/ShopQuanAo/";
	...
	@GetMapping("/search")
	public String search(Model model, @RequestParam(value = "id", required = false) Integer id,
